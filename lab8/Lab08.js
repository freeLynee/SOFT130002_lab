...
toPrevArrow.addEventListener("click", Prev);
toNextArrow.addEventListener("click", Next);
...
for(let i = 0; i < 5; i++) {
    buttons.children[i].addEventListener("click", click);
}
